Classic game played on graph paper. Option to play against a computer with varying difficulty or another user. Grid size can range from 3 x 3 to 10 x 10.
